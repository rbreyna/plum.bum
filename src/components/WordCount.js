...
import { Button,  Col, Row, FormControl, InputGroup, Image } from "react-bootstrap";
...
export default class WordCount extends Component {
    ...
    handleSave = (event) =>{
      ...
      axios.post(("http://localhost:27017/api/entry/" + user_email),newEntry)
         .then(
            this.setState({ message: alert("Your pasage is saved") }))
    }
    render() {
        return (
            <Row className="fluid" id="row-2">
                <Col className="content dash3" sm={12}>
                    <InputGroup>
                        ...
                        <InputGroup id="passage-title" sm={12}>
                            <InputGroup.Prepend>
                                ...
                                >Name of Passage</InputGroup.Text>
                            </InputGroup.Prepend>
                            <FormControl
                            />
                            <br></br>
                    ...
                    <Button id="btns" onClick={this.handleSave}>SAVE</Button>
                </Col>
